...
drop table content;
insert into content(title, writer,date,manager,content,section) values('글제목1','작성자','날짜','담당자1','내용',0);
insert into content(title, writer,date,manager,content,section) values('글제목2','작성자','날짜','담당자2','내용',0);
insert into content(title, writer,date,manager,content,section) values('글제목3','작성자','날짜','담당자3','내용',0);
insert into content(title, writer,date,manager,content,section) values('글제목4','작성자','날짜','담당자4','내용',1);
insert into content(title, writer,date,manager,content,section) values('글제목5','작성자','날짜','담당자5','내용',1);
insert into content(title, writer,date,manager,content,section) values('글제목6','작성자','날짜','담당자6','내용',1);
insert into content(title, writer,date,manager,content,section) values('글제목7','작성자','날짜','담당자7','내용',1);
insert into content(title, writer,date,manager,content,section) values('글제목8','작성자','날짜','담당자8','내용',2);
insert into content(title, writer,date,manager,content,section) values('글제목9','작성자','날짜','담당자9','내용',2);
insert into content(title, writer,date,manager,content,section) values('글제목10','작성자','날짜','담당자10','내용',2);
insert into content(title, writer,date,manager,content,section) values('글제목11','작성자','날짜','담당자11','내용',2);
insert into content(title, writer,date,manager,content,section) values('글제목12','작성자','날짜','담당자12','내용',0);
insert into content(title, writer,date,manager,content,section) values('글제목13','작성자','날짜','담당자13','내용',1);
